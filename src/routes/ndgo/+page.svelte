...
<div class="ndgo-page font-sans bg-white text-black">
	...
	>
		...
		<div class="relative z-10 max-w-3xl px-4 sm:px-6 md:px-8">
			<h2 class="ndgo-hero text-4xl sm:text-5xl font-extrabold mb-4 text-white">
				<span class="text-[#D9042B]">N.D.G.O.</span>
				<span class="text-[#038C25]">Program</span>
			</h2>
			<p class="text-lg sm:text-xl max-w-xl mx-auto mb-6 text-gray-200 leading-relaxed">
				<span class="text-[#F27405] font-semibold">Analog · Digital · Pedagogy</span> — a new way to
				learn computers through art, and art through computers.
			</p>
			<a
