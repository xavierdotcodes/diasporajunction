<script>
	...
	// Itinerary data — replace image URLs with your own assets
	const itinerary = [
		{
			day: 'Day 1–2',
			...
			image:
				'https://images.unsplash.com/photo-1520975913164-9d0902d8a8d8?q=80&w=1400&auto=format&fit=crop&ixlib=rb-4.0.3&s=1'
		},
		{
			day: 'Day 3–4',
			...
			image:
				'https://images.unsplash.com/photo-1563352139-7f8e3d8f6b72?q=80&w=1400&auto=format&fit=crop&ixlib=rb-4.0.3&s=2'
		},
		{
			day: 'Day 5–6',
			...
			image:
				'https://images.unsplash.com/photo-1504198453319-5ce911bafcde?q=80&w=1400&auto=format&fit=crop&ixlib=rb-4.0.3&s=3'
		},
		{
			day: 'Day 7–8',
			...
			image:
				'https://images.unsplash.com/photo-1519681393784-d120267933ba?q=80&w=1400&auto=format&fit=crop&ixlib=rb-4.0.3&s=4'
		},
		{
			day: 'Day 9–10',
			...
			image:
				'https://images.unsplash.com/photo-1542144582-1ba0046e6f10?q=80&w=1400&auto=format&fit=crop&ixlib=rb-4.0.3&s=5'
		}
	];
	...
	onMount(async () => {
		...
		// Animate each itinerary step — content slides from one side, image from the opposite
		gsap.utils.toArray('.itinerary-step').forEach((stepEl, i) => {
			...
			// direction: even -> content from left, image from right. odd -> reversed
			const dir = i % 2 === 0 ? -1 : 1;
...
<style>
	/* small helper to make the page feel long & airy */
	.itinerary-spacer {
		height: 60vh;
	}
</style>
