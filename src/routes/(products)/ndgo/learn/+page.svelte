<script>
	...
	fileLogger('src/routes/(products)/ndgo/learn/+page.svelte');
...
<div class="page">
	...
	<section class="section" id="details">
		...
		<div style="text-align:center; margin-top:2rem;">
			<button class="cta" onclick={openModal}>Register Now</button>
		</div>
	</section>
</div>
...
{#if showModal}
	<div
		...
		role="button"
		tabindex="0"
		aria-label="Close NDGO registration modal"
		onclick={closeModal}
	...
	>
		<div
			...
			role="dialog"
			aria-modal="true"
			aria-labelledby="ndgo-learn-modal-title"
			tabindex="-1"
			onclick={stopPropagation(bubble('click'))}
			onkeydown={stopPropagation}
		>
			<h2 id="ndgo-learn-modal-title">Register for NDGO</h2>
