<script>
	...
	function initStripe() {
		// ✅ Use your PUBLISHABLE key (pk_test_... or pk_live_...)
		stripe = Stripe('pk_test_yourPublishableKey');
	...
	async function handleSubmit(e) {
		...
		// Emit event upward so parent component can call backend
		dispatch('submit', { type: 'card', id: paymentMethod.id });
	}
</script>

<div class="bg-neutral-800 p-4 rounded-lg border border-neutral-600">
	<label class="block text-sm mb-2 text-white">Card Details</label>
